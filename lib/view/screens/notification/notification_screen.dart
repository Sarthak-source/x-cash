                ...
                child: Row(
                  children: [
                    ...
                    Column(
                      ...
                      children: [
                        Text("${data[index]["type"]}", style: regularDefault.copyWith(fontWeight: FontWeight.w500)),
                        const SizedBox(height: Dimensions.space5),
                        Text("${data[index]["date"]} - ${data[index]["time"]}", style: regularSmall.copyWith(color: MyColor.contentTextColor, fontWeight: FontWeight.w500)),
                      ],
                    )
                  ],
                )
