...
class PaymentDetailsForm extends StatefulWidget {
  const PaymentDetailsForm({Key? key}) : super(key: key);
      ...
      child: Column(
        ...
        children: [
          ...
          CustomAnimatedButton(
            ...
            child: Text(MyStrings.makePayment, textAlign: TextAlign.center, style: interRegularDefault.copyWith(color: MyColor.colorWhite, fontWeight: FontWeight.w600)),
          )
        ],
      ),
    );
