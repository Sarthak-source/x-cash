              ...
              child: Column(
                ...
                children: [
                  ...
                  RichText(
                    text: TextSpan(
                      children: [
                        TextSpan(text: data[index]["amount"], style: interRegularDefault.copyWith(fontWeight: FontWeight.w600)),
                        TextSpan(text: " ${data[index]["currency"]}", style: interRegularExtraSmall.copyWith(fontWeight: FontWeight.w600))
                      ]
                    ),
                  ),
