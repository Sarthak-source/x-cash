...
class RouteHelper {
  ...
  List<GetPage> routes = [
    ...
    GetPage(
        name: addMoneyHistoryScreen, page: () => const AddMoneyHistoryScreen()),
    GetPage(name: addMoneyScreen, page: () => const AddMoneyScreen()),
    GetPage(
        name: addMoneyWebScreen,
        page: () => AddMoneyWebView(redirectUrl: Get.arguments)),
    ...
    GetPage(
        name: withdrawPreviewScreen, page: () => const WithdrawPreviewScreen()),
    GetPage(
        name: withdrawHistoryScreen, page: () => const WithdrawHistoryScreen()),
    GetPage(
        name: withdrawMethodScreen, page: () => const WithdrawMethodScreen()),
    GetPage(
        name: addWithdrawMethodScreen,
        page: () => const AddWithdrawMethodScreen()),
    GetPage(
        name: editWithdrawMethod, page: () => const EditWithdrawMethodScreen()),
    ...
    GetPage(
        name: otpScreen,
        page: () => OtpScreen(
            actionId: Get.arguments[0],
            nextRoute: Get.arguments[1],
            otpType: Get.arguments[2])),
