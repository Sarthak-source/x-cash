...
class RequestMoneyResponseModel {
  ...
  RequestMoneyResponseModel.fromJson(dynamic json) {
    _remark = json['remark'];
    _status = json['status'];
...
class Currency {
  Currency({
    ...
    _createdAt = createdAt;
    _updatedAt = updatedAt;
    _moneyRequestLimit = moneyRequestLimit;
}
  ...
  Currency.fromJson(dynamic json) {
    ...
    _createdAt = json['created_at'];
    _updatedAt = json['updated_at'];
    _moneyRequestLimit = json['money_request_limit'].toString();
  }
  int? _id;
  String? _currencyCode;
  ...
  String? get createdAt => _createdAt;
  String? get updatedAt => _updatedAt;
  String? get moneyRequestLimit => _moneyRequestLimit;
  ...
  Map<String, dynamic> toJson() {
    ...
    map['created_at'] = _createdAt;
    map['updated_at'] = _updatedAt;
    map['money_request_limit'] = _moneyRequestLimit;
    return map;
  }
